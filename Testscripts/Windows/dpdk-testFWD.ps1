...
function Confirm-Performance() {
	...
	foreach($testRun in $testDataCsv) {
		...
		if (Confirm-WithinPercentage [int]$testRun.tx_pps_avg [int]$coreData.tx) {
		...
		if (Confirm-WithinPercentage [int]$testRun.fwdrx_pps_avg [int]$coreData.fwdrx) {
		...
		if (Confirm-WithinPercentage [int]$testRun.fwdtx_pps_avg [int]$coreData.fwdtx) {
		...
		if (Confirm-WithinPercentage [int]$testRun.rx_pps_avg [int]$coreData.rx) {
